        ...
        <div className="about-container">
          <div className="about-parent">
            <div className="about-details">
              ...
              <p className="primary-text">
                With a background in Design, I naturally gravitated towards front end development. I
                have skills developing web apps using React and Redux, and full-stack apps with node
                and Express.js.
              </p>
              <p>
                Human skills development and personal growth have played a large part in my dev
                journey. Active listening, giving growth feedback and the ability to receive
                constructive feedback are some of the valuable skills I have developed through Dev
                Academy. I am now ready to bring these skills to my next challenge!{' '}
              </p>
            </div>
            <div className="about-details-stack">
              ...
              <span className="primary-text">
                Github · HTML · CSS · Bootstrap · MUI · Bulma · Flowbite{' '}
              </span>
            </div>
          </div>
        </div>
